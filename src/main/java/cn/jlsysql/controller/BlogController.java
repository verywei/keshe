...
public class BlogController {
    ...
    public ModelAndView index(ModelAndView modelAndView){
        ...
        modelAndView.addObject("hasMore",blogService.getAllBlogs().size()<blogService.countAllBlogs());
        modelAndView.addObject("hotblog",blogService.getAllBlogs());
    ...
    public  ModelAndView classify(@PathVariable String id,ModelAndView modelAndView){
        ...
        if (id.equals("0")){
            ...
            modelAndView.addObject("hasMore",blogService.getBlogByKind(Integer.parseInt(id)).size()<blogService.countBlogByKind(Integer.parseInt(id)));

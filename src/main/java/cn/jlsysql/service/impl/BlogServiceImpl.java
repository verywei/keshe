...
//    @Cacheable(value="common",key="'all_blog'")
    ...
    @Override
    public Integer countAllBlogs() {
        return blogDao.countAllBlogs();
    }

    @Override
    public Integer countBlogByKind(int kind) {
        return blogDao.countBlogByKind(kind);
    }

    @Override
    public Integer countBlogByAuthor(int author) {
        return blogDao.countBlogByAuthor(author);
    }
}

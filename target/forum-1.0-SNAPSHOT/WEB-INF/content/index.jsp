    ...
    <div class="layui-main">
        <div class="layui-row">
            ...
            <div class="layui-col-lg6">
                ...
                <div style="width: 100%;height: 40px;background-color: #FFFFFF;text-align: center;<%if(!(Boolean) request.getAttribute("hasMore"))out.print("visibility: hidden");%>"><button class="layui-btn addrow" style="width: 100%;">加载更多</button></div>
            </div>
                ...
                <div style="margin-left: 10px;margin-top: 10px">
                    ...
                    <div style="background-color:#ffffff;width:278px;margin-top: 10px;padding: 9px">
                        ...
                        <ul style="margin-top: -15px">
                            <%
                                List<Blog> hotblogs= (List<Blog>) request.getAttribute("hotblog");
                                for (int i = 0; i < 5; i++) {
                            %>
                            <li style="margin-top: 15px">
                                <div class="layui-row">
                                    <div class="layui-col-lg4">
                                        <a href="details/<%=hotblogs.get(i).getId()%>"><img src="../../img/img<%=i+6%>.jpg" style="width:90px;"></a>
                                    </div>
